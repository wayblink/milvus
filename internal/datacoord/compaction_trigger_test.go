	...
	tests := []struct {
	...
	}{
		{
			...
			fields{
				...
				&MockAllocator0{},
				nil,
				&spyCompactionHandler{spyChan: make(chan CompactionTask, 1)},
				nil,
			},
			2,
			false,
	...
	tests := []struct {
	...
	}{
		{
			...
			fields{
				...
				newMockAllocator(),
				nil,
				&spyCompactionHandler{spyChan: make(chan CompactionTask, 2)},
				nil,
			},
			args{
				2,
	...
	tests := []struct {
	...
	}{
		{
			...
			fields{
				...
				newMockAllocator(),
				make(chan *compactionSignal, 1),
				&spyCompactionHandler{spyChan: make(chan CompactionTask, 10)},
				nil,
			},
			args{
				2,
