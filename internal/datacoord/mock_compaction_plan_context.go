...
// collectionIsClusteringCompacting provides a mock function with given fields: collectionID
func (_m *MockCompactionPlanContext) collectionIsClusteringCompacting(collectionID int64) (bool, int64) {
...
// MockCompactionPlanContext_collectionIsClusteringCompacting_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'collectionIsClusteringCompacting'
type MockCompactionPlanContext_collectionIsClusteringCompacting_Call struct {
	*mock.Call
}

// collectionIsClusteringCompacting is a helper method to define mock.On call
//   - collectionID int64
func (_e *MockCompactionPlanContext_Expecter) collectionIsClusteringCompacting(collectionID interface{}) *MockCompactionPlanContext_collectionIsClusteringCompacting_Call {
	return &MockCompactionPlanContext_collectionIsClusteringCompacting_Call{Call: _e.mock.On("collectionIsClusteringCompacting", collectionID)}
}

func (_c *MockCompactionPlanContext_collectionIsClusteringCompacting_Call) Run(run func(collectionID int64)) *MockCompactionPlanContext_collectionIsClusteringCompacting_Call {
...
func (_c *MockCompactionPlanContext_collectionIsClusteringCompacting_Call) Return(_a0 bool, _a1 int64) *MockCompactionPlanContext_collectionIsClusteringCompacting_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *MockCompactionPlanContext_collectionIsClusteringCompacting_Call) RunAndReturn(run func(int64) (bool, int64)) *MockCompactionPlanContext_collectionIsClusteringCompacting_Call {
	_c.Call.Return(run)
	return _c
}
