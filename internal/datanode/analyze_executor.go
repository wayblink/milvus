...
type analyzeExecutor struct {
	...
	completed *typeutil.ConcurrentMap[int64, *datapb.AnalyzeStatsResult] // planID to analyzer
	//completedResults *typeutil.ConcurrentMap[int64, *datapb.AnalyzeStatsResult] // planID to AnalyzeStatsResult
...
func (c *analyzeExecutor) executeTask(task analyzer) {
	...
	result, err := task.executeAnalyze()
	if err != nil {
