...
type analyzer interface {
	executeAnalyze() (*datapb.AnalyzeStatsResult, error)
	getPlanID() UniqueID
}

type level2AnalyzeTask struct {
	analyzer
	io        io.BinlogIO
...
func (t *level2AnalyzeTask) executeAnalyze() (*datapb.AnalyzeStatsResult, error) {
...
func (t *level2AnalyzeTask) analyze(
	ctx context.Context,
...
func (t *level2AnalyzeTask) getPlanID() UniqueID {
